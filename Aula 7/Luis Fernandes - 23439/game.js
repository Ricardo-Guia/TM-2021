...
class playGame extends Phaser.Scene{
    ...
    addClouds(){
        ...
        for(let i = 0; i<= 1; i++){
            for(let j = 0; j <= clouds; j++){
                let cloud = this.add.sprite(128 * Phaser.Math.Between(-10,10), game.config.height + i * 32 + Phaser.Math.Between(-10,10),"cloud");
                cloud.setFrame(i);
    ...
    showGameOver(){
        ...
        logo.on("pointerup", function(){
            window.location.href = "https://www.extremelf.pt/"
        }, this);
